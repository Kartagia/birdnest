...
public class RestPath {
    ...
    /**
     * The list containing parts of the restful URI.
    ...
    public class RestResource {
        ...
        /**
         * Creates a new rest resource with given parameters.
         * 
         * @param baseUri    The base uri. If undefined, defaults to no base uri.
         * @param parameters The rest parameters of the resource.
    ...
    public RestPath(String basePath, RestParameter<?>... restParameters) throws IllegalArgumentException {
        parts.add(this.new RestResource(basePath, restParameters));
    }

    public RestPath(String basePath, String resourcePath, RestParameter<?>... restParameters)
    ...
    /**
     * Convert the REST path to the URI containing the REST path.
     * 
    ...
    public URI getUri(java.util.Map<String, ?> parameters) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalStateException("Any transformation of the values resulted invalid URI", uri);
        }

    }

    /**
     * Get the relative URI of the rest path.
     * 
     * @param parameters The parameters of the uri. 
     * @return The rest path URI containing given parameter values.
     * @throws IllegalArgumentException The parameter list contained invalid
